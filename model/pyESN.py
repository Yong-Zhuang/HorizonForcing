...
class ESN():
    ...
    def inference(self, input_seq,pred_steps, x_y_lag=1):
        ...
        """    
        assert len(input_seq.shape) ==2, "input sequence should be greater 2 dimensions: (time steps, feature dimension)"
        ...
        for step in range(pred_steps):
            ...
            sequence = np.append(sequence,prediction[-x_y_lag:],axis = 0)
